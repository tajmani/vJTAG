# -----------------------------------------------------------------
# boards/de2/cyclone2/sld_vjtag_to_gpio/scripts/vjtag_cmds.tcl
#
# 11/1/2010 D. W. Hawkins (dwh@ovro.caltech.edu)
#
# Altera Virtual JTAG interface procedures for the DE2 example.
#
# This script contains;
#  - helper functions for JTAG access (jtag_open/close)
#  - procedures to implement JTAG IDCODE, USERCODE, and NCONFIG
#    instructions
#  - JTAG hub interrogation procedures as described in Appendix
#    A of the Virtual JTAG User's Guide.
#
# -----------------------------------------------------------------
